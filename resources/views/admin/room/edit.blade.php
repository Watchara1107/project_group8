        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-9">
                    ...
                    <div class="card-body">
                        <div>
                            <form action="{{ url('/admin/room/update/'.$room->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <input type="text" name="name" class="form-control" id="defaultFormControlInput"
                                    aria-describedby="defaultFormControlHelp" value="{{ $room->name }}" />
                                ...
                                <input type="text" name="price" class="form-control" id="defaultFormControlInput"
                                    aria-describedby="defaultFormControlHelp" value="{{ $room->price }}" />
                                ...
                                <input type="file" name="image" class="form-control" id="defaultFormControlInput"
                                    aria-describedby="defaultFormControlHelp"value="{{ $room->image }}" />
                                <div class="row mt-4 ml-2">
                                    <img src="{{ asset('admin/upload/room/'.$room->image) }}" width="120px" height="120px" alt="">
                                </div>
